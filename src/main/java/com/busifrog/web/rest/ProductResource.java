...
/**
 * REST controller for managing {@link com.busifrog.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingProduct -> {
                    ...
                    if (product.getFilePath() != null) {
                        existingProduct.setFilePath(product.getFilePath());
                    }
                    if (product.getFileType() != null) {
                        existingProduct.setFileType(product.getFileType());
                    }
                    ...
                    if (product.getExternalLink() != null) {
                        existingProduct.setExternalLink(product.getExternalLink());
                    }
