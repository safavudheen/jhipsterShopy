...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SELLERPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_SELLERPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SELLERPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SELLERPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SELLERPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SELLERPLAN actions', async () => {
      const expectedActions = [
        {
