...
export const PackagePlan4 = (props: RouteComponentProps<{ id: string }>) => {
  return (
    <div>
          ...
          <Row>
            ...
            <Col md="4" lg="4" sm="12">
              <div className="select_plan_heading">
                <h3 className="select_plan_heading text-info p-4">Choose Package Plan 4</h3>
              </div>
