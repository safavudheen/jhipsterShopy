...
export const PackagePlan1 = (props: RouteComponentProps<{ id: string }>) => {
  return (
    <div>
      <Row className="pl-5 pt-1" style={{ minHeight: '30rem' }}>
        <Col md="12" className="pl-3">
          <Row>
            <Col lg="4" md="4" hidden-xs hidden-sm></Col>
            <Col md="4" lg="4" sm="12">
              <div className="select_plan_heading">
                <h3 className="select_plan_heading text-info p-4">Choose Package Plan 1</h3>
              </div>
              <div className="package_plan_card">
                <Card body inverse color="info" className="plan_card" style={{ textAlign: 'center' }}>
