...
export const PackagePlan2 = (props: RouteComponentProps<{ id: string }>) => {
  return (
    <div>
          ...
          <Row>
            ...
            <Col md="4" lg="4" sm="12">
              <div className="select_plan_heading">
                <h3 className="select_plan_heading text-warning p-4">Choose Package Plan 2</h3>
              </div>
              <div className="package_plan_card">
                <Card body inverse color="warning" className="plan_card" style={{ textAlign: 'center' }}>
