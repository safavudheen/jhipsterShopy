...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERVISIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERVISIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERVISIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERVISIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERVISIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERVISIT actions', async () => {
      const expectedActions = [
        {
